		...
		getFunction : function() {
			...
			try {
				...
				navigator.vehicle.steeringWheelAngle.get(zone).then(
						...
						function (error) {
							console.log("AMB: There was an error on the steeringWheelAngle get: " + error.message);
						});
			} catch(ex) {
		...
		getFunction : function() {
			...
			try {
				...
				tizen.vehicle.yawRate.get(zone).then(function (YawRate) {
						...
						function (error) {
							console.log("AMB: There was an error on the YawRate get: " + error.message);
						});
			} catch (ex) {
			...
			getFunction : function() {
				...
				try {
					...
					navigator.vehicle.wheelBrake.get(zone).then(function (WheelBrake) {
							...
							function (error) {
								console.log("AMB: There was an error on the WheelBrake get: " + error.message);
							});
				} catch (ex) {
		...
		getFunction : function() {
			...
			try {
				...
				navigator.vehicle.tyrePressureFLMS.get(zone).then(function (tirePressure) {
						...
						function (error) {
							console.log("AMB: There was an error on the TyrePressureFLMS get: " + error.message);
							ambFailCnt--;
						});
			} catch (ex) {
		...
		getFunction : function() {
			...
			try {
				...
				navigator.vehicle.tyrePressureFRMS.get(zone).then(function (tirePressure) {
						...
						function (error) {
							console.log("AMB: There was an error on the TyrePressureFRMS get: " + error.message);
						});
			} catch (ex) {
		...
		getFunction : function() {
			...
			try {
				...
				navigator.vehicle.tyrePressureRLMS.get(zone).then(function (tirePressure) {
						...
						function (error) {
							console.log("AMB: There was an error on the TyrePressureRLMS get: " + error.message);
						});
			} catch (ex) {
		...
		getFunction : function() {
			...
			try {
				...
				navigator.vehicle.tyrePressureRRMS.get(zone).then(function (tirePressure) {
						...
						function (error) {
							console.log("AMB: There was an error on the TyrePressureRRMS get: " + error.message);
						});
			} catch (ex) {
		...
		getFunction : function() {
			...
			try {
				...
				navigator.vehicle.ChildLockStatus.get(zone).then(function (childLock) {
						...
						function (error) {
							console.log("AMB: There was an error on the childLock get: " + error.message);
						});
			} catch (ex) {
		...
		setFunction : function(val) {
			...
			try {
				...
				navigator.vehicle.fLHSDistrCmd.set({"FLHSDistrCmd": val}, zone).then(
						...
						function (failure) {
							console.log("AMB: There was an error on the AirflowDirection-FLHSDistrCmd set: " + failure.message);
						}
				);
			} catch (ex) {
		...
		getFunction : function() {
			...
			try {
				...
				navigator.vehicle.ambientTemp.get(zone).then(function (temp) {
						...
						function (error) {
							console.log("AMB: There was an error on the AmbientTemp get: " + error.message);
						});
			} catch (ex) {
		...
		getFunction : function() {
			...
			try {
				...
				navigator.vehicle.inCarTemp.get(zone).then(function (temp) {
						...
						function (error) {
							console.log("AMB: There was an error on the InCarTemp get: " + error.message);
						});
			} catch (ex) {
		...
		getFunction : function() {
			...
			try {
				...
				navigator.vehicle.fuelLevelIndicatedMS.get(zone).then(function (level) {
						...
						function (error) {
							console.log("AMB: There was an error on the FuelLevelIndicatedMS get: " + error.message);
						});
			} catch (ex) {
		...
		getFunction : function() {
			...
			try {
				...
				navigator.vehicle.distanceToEmpty.get(zone).then(function (dist) {
						...
						function (error) {
							console.log("AMB: There was an error on the DistanceToEmpty get: " + error.message);
						});
			} catch (ex) {
		...
		getFunction : function() {
			...
			try {
				...
				navigator.vehicle.oDORollingCount2101.get(zone).then(function (dist) {
						...
						function (error) {
							console.log("AMB: There was an error on the ODORollingCount2101 get: " + error.message);
						});
			} catch (ex) {
		...
		getFunction : function() {
			...
			try {
				...
				navigator.vehicle.vehicleSpeed.get(zone).then(function (vehicleSpeed) {
						...
						function (error) {
							console.log("AMB: There was an error on the speed get: " + error.message);
							ambFailCnt--;
						});
			} catch (ex) {
		...
		setFunction : function(val) {
			...
			try {
				...
				navigator.vehicle.directionIndicationINST.set({"DirectionIndicationINST": val}, zone).then(
						...
						function (failure) {
							console.log("AMB: There was an error on the DirectionIndicationINST set: " + failure.message);
						}
				);
			} catch (ex) {
		...
		setFunction : function(val) {
			...
			try {
				...
				navigator.vehicle.directionIndicationMS.set({"DirectionIndicationMS": val}, zone).then(
						...
						function (failure) {
							console.log("AMB: There was an error on the DirectionIndicationMS set: " + failure.message);
						}
				);
			} catch (ex) {
		...
		setFunction : function(val) {
			...
			try {
				...
				navigator.vehicle.aCCommand.set({"ACCommand": val}, zone).then(
						...
						function (failure) {
							console.log("AMB: There was an error on the ACCommand set: " + failure.message);
						}
				);
			} catch (ex) {
		...
		setFunction : function(val) {
			...
			try {
				...
				navigator.vehicle.recircReq.set({"RecircReq": val}, zone).then(
						...
						function (failure) {
							console.log("AMB: There was an error on the RecircReq set: " + failure.message);
						}
				);
			} catch (ex) {
		...
		setFunction : function(val) {
			...
			try {
				...
				navigator.vehicle.frontTSetRightCmd.set({"FrontTSetRightCmd": val}, zone).then(
						...
						function (failure) {
							console.log("AMB: There was an error on the FrontTSetRightCmd set: " + failure.message);
						}
				);
			} catch (ex) {
		...
		setFunction : function(val) {
			...
			try {
				...
				navigator.vehicle.frontTSetLeftCmd.set({"FrontTSetLeftCmd": val}, zone).then(
						...
						function (failure) {
							console.log("AMB: There was an error on the FrontTSetLeftCmd set: " + failure.message);
						}
				);
			} catch (ex) {
		...
		setFunction : function(val) {
			...
			try {
				...
				navigator.vehicle.frontBlwrSpeedCmd.set({"FrontBlwrSpeedCmd": val}, zone).then(
						...
						function (failure) {
							console.log("AMB: There was an error on the FrontBlwrSpeedCmd set: " + failure.message);
						}
				);
			} catch (ex) {
		...
		setFunction : function(val) {
			...
			try {
				...
				navigator.vehicle.heatedSeatFRRequest.set({"HeatedSeatFRRequest": val}, zone).then(
						...
						function (failure) {
							console.log("AMB: There was an error on the HeatedSeatFRRequest set: " + failure.message);
						}
				);
			} catch (ex) {
			...
			try {
				...
				if (typeof(navigator.vehicle) !== "undefined") {
					navigator.vehicle.heatedSeatFRRequest.get(zone).then(function (value) {
							...
							function (error) {
								console.log("AMB: There was an error on the HeatedSeatFRRequest get: " + error.message);
							});
				}
			} catch (ex) {
		...
		setFunction : function(val) {
			...
			try {
				...
				navigator.vehicle.heatedSeatFLRequest.set({"HeatedSeatFLRequest": val}, zone).then(
						...
						function (failure) {
							console.log("AMB: There was an error on the HeatedSeatFLRequest set: " + failure.message);
						}
				);
			} catch (ex) {
			...
			try {
				...
				if (typeof(navigator.vehicle) !== "undefined") {
					navigator.vehicle.heatedSeatFLRequest.get(zone).then(function (value) {
							...
							function (error) {
								console.log("AMB: There was an error on the HeatedSeatFLRequest get: " + error.message);
							});
				}
			} catch (ex) {
		...
		setFunction : function(val) {
			...
			try {
				...
				navigator.vehicle.fLHSDistrCmd.set({"FLHSDistrCmd": val}, zone).then(
						...
						function (failure) {
							console.log("AMB: There was an error on the FLHSDistrCmd set: " + failure.message);
						}
				);
			} catch (ex) {
		...
		setFunction : function(val) {
			...
			try {
				...
				navigator.vehicle.fRHSDistrCmd.set({"FRHSDistrCmd": val}, zone).then(
						...
						function (failure) {
							console.log("AMB: There was an error on the FRHSDistrCmd set: " + failure.message);
						}
				);
			} catch (ex) {
